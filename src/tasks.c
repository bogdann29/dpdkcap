...
/**
 * @brief Applies the key-value pair to the task configuration.
 *
 * @param key The key of the configuration parameter.
 * @param val The value of the configuration parameter.
 * @param cbd Pointer to the task structure to which the configuration will be applied.
 */
...
/**
 * @brief Compiles the BPF filter string for a given task and initializes the task's BPF filter.
 *
 * @param task The task for which the BPF filter needs to be compiled.
 */
...
/**
 * @brief Callback 	function for scanning a task within a directory.
 *
 * @param fn The name of the file in the directory.
 * @param fd The file descriptor of the file.
 * @param st Pointer to the stat struct describing the file.
 * @param cbd Pointer to the task directory structure containing the tasks.
 */
