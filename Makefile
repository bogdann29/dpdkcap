...
SOURCES := dpdkcap.c parser.c core_write.c core_capture.c statistics.c timestamp.c numa.c tasks.c parse.c pcap.c utils.c lzo/minilzo/minilzo.c lzo/lzowrite.c
